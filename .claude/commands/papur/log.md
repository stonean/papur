...
- Suggested next step: "Run `/papur:groom` when you're ready to walk the inbox and route items to their proper homes."
- **Stop here.** Do not start grooming or implementation. The user invokes `/papur:groom` explicitly.
